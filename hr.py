...
class hr_employee(osv.osv):
    ...
    _columns = {
        ...
        'name_related': fields.related('resource_id', 'name', type='char', track_visibility='onchange',string='Name', readonly=True, store=True),
        ...
        'ssnid': fields.char('SSN No', help='Social Security Number',track_visibility='onchange'),
        'sinid': fields.char('SIN No', help="Social Insurance Number",track_visibility='onchange'),
        'identification_id': fields.char('Identification No',track_visibility='onchange'),
        'otherid': fields.char('Other Id',track_visibility='onchange'),
        'gender': fields.selection([('male', 'Male'), ('female', 'Female')], 'Gender',track_visibility='onchange'),
        'marital': fields.selection([('single', 'Single'), ('married', 'Married'), ('widower', 'Widower'), ('divorced', 'Divorced')], 'Marital Status',track_visibility='onchange'),
        ...
        'bank_account_id': fields.many2one('res.partner.bank', 'Bank Account Number', domain="[('partner_id','=',address_home_id)]", help="Employee bank salary account",track_visibility='onchange'),
        'work_phone': fields.char('Work Phone', readonly=False,track_visibility='onchange'),
        'mobile_phone': fields.char('Work Mobile', readonly=False,track_visibility='onchange'),
        'work_email': fields.char('Work Email', size=240,track_visibility='onchange'),
        ...
        'category_ids': fields.many2many('hr.employee.category', 'employee_category_rel', 'emp_id', 'category_id', 'Tags',track_visibility='onchange'),
        'child_ids': fields.one2many('hr.employee', 'parent_id', 'Subordinates',track_visibility='onchange'),
        ...
        'image': fields.binary("Photo",
            help="This field holds the image used as photo for the employee, limited to 1024x1024px.",track_visibility='onchange'),
        'image_medium': fields.function(_get_image, fnct_inv=_set_image,
            ...
            help="Medium-sized photo of the employee. It is automatically "\
                 ...
                 "Use this field in form views or some kanban views.",track_visibility='onchange'),
        'image_small': fields.function(_get_image, fnct_inv=_set_image,
            ...
            help="Small-sized photo of the employee. It is automatically "\
                 ...
                 "Use this field anywhere a small image is required.",track_visibility='onchange'),
        'passport_id': fields.char('Passport No',track_visibility='onchange'),
        'color': fields.integer('Color Index',track_visibility='onchange'),
        'city': fields.related('address_id', 'city', type='char', string='City',track_visibility='onchange'),
        'login': fields.related('user_id', 'login', type='char', string='Login', readonly=1,track_visibility='onchange'),
        'last_login': fields.related('user_id', 'date', type='datetime', string='Latest Connection', readonly=1,track_visibility='onchange'),
    }
